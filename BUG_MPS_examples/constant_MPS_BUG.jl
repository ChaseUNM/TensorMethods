...
# init_MPS_bug = orthogonalize!(init_MPS, 5)
...
ans_tdvp, _, _, _, _ = tdvp2_constant(H_mpo, init_MPS, t0, T, steps; strang = false)
...
bug_mps_vec = vectorize_mps(ans_mps_bug1; order = "natural")
tdvp_vec = vectorize_mps(ans_tdvp; order = "natural")
bug3_mps_vec = vectorize_mps(ans_mps_bug3; order = "natural")
bug4_mps_vec = vectorize_mps(ans_mps_bug4; order = "natural")
