...
pcof = vec(readdlm("../spline_parms/params_$nqubits.dat"))
...
if BUG_MPS == true 
    ans_bug_mps,link_bug_mps,magnet_bug_mps,energy_bug_mps = mps_bug(H_d, bc_params, init_mps, t0, T, steps; cutoff = cutoff^2, magnet = false, energy = false)
